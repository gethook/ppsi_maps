...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('login'); ?>"><?php echo $title; ?></a>
  </div>

  <?php if ($this->session->flashdata('sukses_register')) {
    echo '<div class="alert alert-success alert-dismissable">';
    echo '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>';
    echo $this->session->flashdata('sukses_register');
    echo '</div>';
  }
  ...
  if ($this->session->flashdata('success_logout')) {
    echo '<div class="alert alert-success alert-dismissable">';
    echo '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>';
    echo $this->session->flashdata('success_logout');
    echo '</div>';
   }
  ...
  <div class="login-box-body">
    ...
    <?php echo form_open('login'); ?>
      ...
      <div class="row">
        <div class="col-xs-12">
          <span>Belum punya akun? <a href="<?php echo base_url('register'); ?>" class="text-center">Daftar</a></span>
        </div>
      </div>
    <?php echo form_close(); ?>
