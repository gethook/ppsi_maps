<div class="col-md-12">
	...
	<div class="box box-primary">
		<div class="box-body">
			<?php echo form_open_multipart('proyek/tambah'); ?>			
			<div class="form-group">
				<label for="project_name">Nama proyek</label>
				<input type="text" name="project_name" class="form-control" value="<?php echo set_value('project_name'); ?>" required="">
			</div>
			<div class="form-group">
				<label for="project_description">Deskripsi</label>
				<textarea name="project_description" class="form-control textarea"><?php echo set_value('project_description'); ?></textarea>
			</div>
			<div class="form-group">
				...
				<select name="area_id" id="" class="form-control select2">
					...
					?>
					<option value="<?php echo $kota['area_id']; ?>">
			...
			<div class="form-group">
				...
				<textarea name="project_address" class="form-control"><?php echo set_value('project_address'); ?></textarea>
			</div>
			<div class="form-group">
				<label for="project_gmaps">Link Gmaps</label>
				<input type="text" name="project_gmaps" class="form-control" value="<?php echo set_value('project_gmaps'); ?>">
			</div>
			...
			<div class="form-group">
				...
				<select class="form-control select2" name="status_unit_id" required="">
					<?php foreach($status_unit as $status): ?>
						<option value="<?php echo $status['status_unit_id']; ?>"><?php echo $status['status_unit_name']; ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea name="project_note" class="form-control textarea"><?php echo set_value('project_note'); ?></textarea>
			</div>
